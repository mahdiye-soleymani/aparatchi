                            ...
                            <form  role="form" method="post" action="">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?php echo $zicco['listmemberbyid']->info;?>" name="infoupdateregister" class="form-control" id="exampleInputEmail1">
                                    </div>
                                    <div class="form-group">
                                        <p>ایمیل کاربر</p>
                                        <input type="email" value="<?php echo $zicco['listmemberbyid']->email;?>" name="emailupdateregister" class="form-control" id="exampleInputEmail1">
                                    </div>
                                    <div class="form-group">
                                        <p>نام کاربری کاربر</p>
                                        <input type="text" name="usernameupdateregister" value="<?php echo $zicco['listmemberbyid']->username;?>" class="form-control" id="exampleInputEmail1">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="banmember" value="<?php echo $zicco['listmemberbyid']->status;?>" class="form-control" id="exampleInputEmail1">
                                    </div>
